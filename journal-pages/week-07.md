...
*After walking Alissa through my first rulebook iteration and explaining what I was trying to achieve, she came back with three what-if variations that pushed my thinking in directions I hadn't considered.*

#### 1. What if the yarn colour was the least important element, and texture did the heavy lifting instead?
*Alissa suggested flipping the hierarchy so that rough, smooth, and twisted textures encoded the emotional quality of contact rather than relying on colour. This would make the piece more tactile and reward physical interaction with the work rather than just visual reading from a distance.*
